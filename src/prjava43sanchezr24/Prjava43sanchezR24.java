...
public class Prjava43sanchezR24 extends Frame 
   ...
   public Prjava43sanchezR24 () { 
      ...
      setTitle("nova finestra prjava43sanchezR24");  // "this" Frame sets title 
   ...
   public static void main(String[] args) { 
      new Prjava43sanchezR24();  // Let the construct do the job 
   } 
